...
#' @return A database environment handle.
#' @author Jeffrey A. Ryan
#' @seealso \code{\link{Environments}}\cr \code{\link{db_create}}
#' @references Oracle Berkeley DB API\cr
#' \url{http://www.oracle.com/technetwork/database/database-technologies/berkeleydb/overview/index.html}\cr
#' @keywords database
#' @examples
#'
#' \dontrun{
